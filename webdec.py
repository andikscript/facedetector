...
def show_webcam(mirror=False):
    ...
    while True:
        ...
        if cv2.waitKey(1) == 27:
            fileN=str(ss)+'.png'# membuat string nama image yang disimpan
            ...
            s = ss+1 # increase variable penamaan image agar penyimpanan selanjutnya tidak menimpa file yang lama 
            break  # esc to quit
